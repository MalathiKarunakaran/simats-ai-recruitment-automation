...
import type { EmployeeOffboardPayload, EmployeeOffboardResponse, EmployeeRead, PaginatedResponse } from "@/api/types";
...
export async function offboardEmployee(id: string, payload: EmployeeOffboardPayload): Promise<EmployeeOffboardResponse> {
  return apiFetch<EmployeeOffboardResponse>(`/employees/${id}/offboard`, {
    method: "POST",
