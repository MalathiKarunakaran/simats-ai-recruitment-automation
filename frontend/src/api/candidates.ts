...
import type { CandidateCreatePayload, CandidateRead, PaginatedResponse } from "@/api/types";

export async function listCandidates(emailFilter?: string): Promise<CandidateRead[]> {
