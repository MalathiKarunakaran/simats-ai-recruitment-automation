...
describe("InterviewsListPage", () => {
  ...
  it("shows the schedule button to a role without write access individually granted SCHEDULE_INTERVIEW", async () => {
    mockedUseAuth.mockReturnValue({
      user: { role: "CAMPUS_HOD" } as UserRead,
      isLoading: false,
      login: vi.fn(), requestOtp: vi.fn(), loginWithOtp: vi.fn(),
    ...
    await waitFor(() => expect(screen.getByText("Schedule interview")).toBeInTheDocument());
  });
